...
<header id="main-header">
          <div class="wrap">
               <div id="back-arrow">
               <a href="Front.php"><img src="./images/left.png" id="left"></a>
               </div>
		...
		?>
	               ...
	               &nbsp; &nbsp;
               <img src="./images/cogs.png" id="cogs"> &nbsp;&nbsp; <img src="./images/download-32.png" id="download"> &nbsp;&nbsp;<span style="color:#27c6f4;font-family:'Arial Narrow';">Alpha</span>
               </div>
          </div>
     </header>
...
<div id="toolbar-icon">
<img id="switch-icon" src="./images/switch-off.png">
</div>
...
<div id="trash">
<img id="dustbin" src="./images/trash-empty.png">
</div>
